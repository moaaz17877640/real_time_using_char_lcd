...
static void eusart_baudrate_configuration(const eusart_t *_eusa){
    ...
    if(BAUDRATE_ASYNCHRONOUS_8BIT_LOW_SPEED ==_eusa->baud_rate_formula ){
        ...
        BAUDCONbits.BRG16 = 0 ;
        TXSTA1bits.BRGH = 0 ;
    baud_temp = (8000000UL /(float)_eusa->baud_rate_value /64.0) - 1 ;
    }
        ...
        BAUDCONbits.BRG16 = 0 ;
        TXSTA1bits.BRGH = 1 ;
    baud_temp = (8000000UL /(float)_eusa->baud_rate_value /16.0) - 1 ;
    }
     ...
     TXSTA1bits.SYNC =0 ;
        BAUDCONbits.BRG16 = 1 ;
        TXSTA1bits.BRGH = 1 ;
         baud_temp = (8000000UL /(float)_eusa->baud_rate_value /4.0) - 1 ;
    }
