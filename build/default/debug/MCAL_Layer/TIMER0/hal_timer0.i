...
# 11 "MCAL_Layer/TIMER0/hal_timer0.h"
# 1 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 12 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 12 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 1
# 12 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h"
# 1 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../Std_Libraries.h" 1
# 12 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../Std_Libraries.h"
...
# 12 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
...
# 12 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 2

# 1 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../compiler.h" 1
# 11 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../compiler.h"
...
# 11 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/../compiler.h" 2
...
# 32 "MCAL_Layer/TIMER0/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOGIC_LOW,
            LOGIC_HIGH
}logic_t;
...
# 13 "MCAL_Layer/TIMER0/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
...
# 53 "MCAL_Layer/TIMER0/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 1 "MCAL_Layer/TIMER0/../../MCAL_Layer/Interrupt/mcal_interrupt_manager.h" 1
# 24 "MCAL_Layer/TIMER0/../../MCAL_Layer/Interrupt/mcal_interrupt_manager.h"
void INT0_ISR(void);
void INT1_ISR(void);
void INT2_ISR(void);
...
static __attribute__((inline)) void Prescaler_configure(const Timer0_t *TMR );
static __attribute__((inline)) void MODE_configure(const Timer0_t *TMR );

static __attribute__((inline)) void register_configure(const Timer0_t *TMR );

static void (*TIMER0_INTERRUPPT)(void)= ((void*)0);
...
static __attribute__((inline)) void Prescaler_configure(const Timer0_t *TMR ){
    if(1 == TMR->Prescaler_enable){
    (T0CONbits.PSA = 1 );
    T0CONbits.T0PS = TMR->Prescaler_value ;
    }
    else if(0 == TMR->Prescaler_enable){
    (T0CONbits.PSA = 0 );
    }
    else {
...
static __attribute__((inline)) void MODE_configure(const Timer0_t *TMR ){
    if(0 ==TMR->timer0_mode)
    {
    (T0CONbits.T0CS = 0);
    }
    else if(1 ==TMR->timer0_mode)
    {
    (T0CONbits.T0CS = 1);
     if(1 ==TMR->counter_edge)
    {
    (T0CONbits.T0SE = 1);
    }
    else if(0 ==TMR->counter_edge)
    {
    (T0CONbits.T0SE = 0);
    }
    else{
    ...
    static __attribute__((inline)) void register_configure(const Timer0_t *TMR ){
    if(0 == TMR->timer_register_size){
    (T0CONbits.T08BIT = 0) ;
    }else if(1 == TMR->timer_register_size){
    (T0CONbits.T08BIT = 1) ;
    }else {
