...
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../Std_Libraries.h"
...
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
...
# 32 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOGIC_LOW,
            LOGIC_HIGH
}logic_t;
...
# 14 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h" 2
# 53 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) Std_ReturnType adc_select_format(const ADc_t *adc_obj );
static __attribute__((inline)) Std_ReturnType adc_select_Voltage(const ADc_t *adc_obj );
static __attribute__((inline)) Std_ReturnType adc_configure_pin(const Adc_select_Channel_t adc_obj );
...
Std_ReturnType Adc_is_conversion_done(const ADc_t *adc_obj , uint8 *conversion_status ){
    Std_ReturnType ret =(Std_ReturnType)0x00 ;
    if((((void*)0) == adc_obj)&&(((void*)0) ==conversion_status))
    {
        ret =(Std_ReturnType)0x00 ;
...
Std_ReturnType Adc_Get_conversion_result(const ADc_t *adc_obj , uint16 *conversion_result ){
    Std_ReturnType ret =(Std_ReturnType)0x00 ;
    if((((void*)0) == adc_obj)&&(((void*)0) ==conversion_result))
    {
        ret =(Std_ReturnType)0x00 ;
    }
    else{
        if(( 0x01) == adc_obj->result_format){
           *conversion_result = (uint16)((ADRESH << 8) + ADRESL);

        }
        else if(( 0x00) == adc_obj->result_format){
...
static __attribute__((inline)) Std_ReturnType adc_select_Voltage(const ADc_t *adc_obj ){
 Std_ReturnType ret =(Std_ReturnType)0x00 ;
    if((((void*)0) == adc_obj))
    {
        ...
        if(0x01U == adc_obj->voltage_reference){
      do{ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG0 = 1; }while(0);
        }
        else if(0x00U == adc_obj->voltage_reference){
...
static __attribute__((inline)) Std_ReturnType adc_configure_pin(const Adc_select_Channel_t adc_obj ){
  Std_ReturnType ret = (Std_ReturnType)0x01 ;
        ...
        switch(adc_obj){
         case AN0_CHANNEL: (TRISA |= ( (uint8) 1 << 0x0 )); break;

            case AN1_CHANNEL : (TRISA |= ( (uint8) 1 << 0x1 )); break;

        case AN2_CHANNEL: (TRISA |= ( (uint8) 1 << 0x2 )); break;

         case AN3_CHANNEL: (TRISA |= ( (uint8) 1 << 0x3 )); break;

         case AN4_CHANNEL: (TRISA |= ( (uint8) 1 << 0x5 )); break;

          case AN5_CHANNEL: (TRISE |= ( (uint8) 1 << 0x0 )); break;

         case AN6_CHANNEL: (TRISE |= ( (uint8) 1 << 0x1 )); break;

          case AN7_CHANNEL: (TRISE |= ( (uint8) 1 << 0x2 )); break;

         case AN8_CHANNEL: (TRISB |= ( (uint8) 1 << 0x2 )); break;

          case AN9_CHANNEL: (TRISB |= ( (uint8) 1 << 0x3 )); break;

          case AN10_CHANNEL: (TRISB |= ( (uint8) 1 << 0x1 )); break;

          case AN11_CHANNEL: (TRISB |= ( (uint8) 1 << 0x4 )); break;
          case AN12_CHANNEL: (TRISB |= ( (uint8) 1 << 0x0 )); break;
        }
