...
Std_ReturnType gpio_pin_direction_intialize(const pin_config_t *__pin_t){
    ...
    if( ((void*)0) ==__pin_t ||__pin_t ->pin > (8)-1 )
    {
    ...
    {
        case OUTPUT :
            (*tris_registers[__pin_t ->port] &= ~( (uint8) 1 << __pin_t ->pin ));
            break;
        case INPUT :
            (*tris_registers[__pin_t ->port] |= ( (uint8) 1 << __pin_t ->pin ));
            break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_t , direction_t *direction){
       Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) ==_pin_t || _pin_t->pin > (8)-1||((void*)0)==direction )
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
    *direction = ((*tris_registers[_pin_t ->port] >> _pin_t ->pin)& (uint8) 1);

    }

    return ret;
}
# 77 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_t,logic_t logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if( ((void*)0) ==_pin_t || _pin_t->pin > (8)-1 )
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        switch(logic){
            case LOGIC_HIGH :
              (*lat_registers[_pin_t->port] |= ( (uint8) 1 << _pin_t->pin )) ;
              break;
            case LOGIC_LOW :
            (*lat_registers[_pin_t->port] &= ~( (uint8) 1 << _pin_t->pin )) ;
            break;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_t, logic_t *logic ){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if( ((void*)0) ==_pin_t || _pin_t->pin >(8)-1 ||((void*)0) == logic)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 132 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *__pin_t ){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((((void*)0) ==__pin_t)|| __pin_t->pin > (8)-1 )
    {
    ...
    {
       (*lat_registers[__pin_t->port] ^= ( (uint8) 1 << __pin_t->pin ));
...
# 179 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_direction_intialize(port_index_t port,uint8 direction){
   Std_ReturnType ret = (Std_ReturnType)0x01;
   if(port > (5)){
       ret = (Std_ReturnType)0x00;
...
# 222 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_write_logic(port_index_t port,uint8 logic){
  Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 269 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port ){
  Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port > (5))
    {
